...
class AppLanguageTest {
    ...
    @Test fun explicitBokmalSurvivesMigration() = assertEquals(AppLanguage.BOKMAL, AppLanguage.initial("nb", true))
    ...
    @Test fun tagsAreStableAndUnique() = assertEquals(listOf("", "nn", "nb", "en"), AppLanguage.entries.map { it.tag })
}

...
private val demoTitles = listOf(
    ...
    DemoTitle("demo-nordlys", "Nordlys", R.drawable.demo_coast, "Drama",
    ...
    DemoTitle("demo-desember", "Heim til desember", R.drawable.demo_winter, "Romantikk",
    ...
    DemoTitle("demo-huset", "Huset i skogen", R.drawable.demo_manor, "Mystikk",
    ...
    DemoTitle("demo-midnatt", "Etter midnatt", R.drawable.demo_manor, "Thriller",
        "Den siste bussen køyrer forbi same huset tre gonger. Ein passasjer bestemmer seg for å gå av.", ServiceKind.EMBY, score = "7,9"),
    DemoTitle("demo-blaatime", "Den blå timen", R.drawable.demo_coast, "Drama",
    ...
    DemoTitle("demo-vinterveg", "Vintervegen", R.drawable.demo_winter, "Eventyr",
    ...
    DemoTitle("demo-kystvakta", "Kystvakta", R.drawable.demo_coast, "Krim",
    ...
    DemoTitle("demo-desemberdagar", "Desemberdagar", R.drawable.demo_winter, "Drama",
    ...
    DemoTitle("demo-spor", "Mørke spor", R.drawable.demo_manor, "Mystikk",
    ...
    DemoTitle("demo-leia", "Langs leia", R.drawable.demo_coast, "Dokumentar",
    ...
    DemoTitle("demo-vinterlys", "Vinterlys", R.drawable.demo_winter, "Drama",

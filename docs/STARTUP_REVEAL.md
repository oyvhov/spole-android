...
- «Spole» tonar inn med 12 dp rørsle i 280 ms, og ei diskret lastelinje går under teksten.
- Etter innfadinga ventar dekkjet kortare på første synkronisering: høgast 280 ms før interaktivt skjelett. Deretter tonar det ut i 240 ms. Nettverksfeil kan ikkje halde brukaren fast.
